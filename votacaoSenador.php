...
$arquivoCsv = 'candidatos/candidatos_senador.csv';
  ...
  <div class="row">
      ...
      <div class="p-3 mb-3 bg-light rounded">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Votação para Senador</li>
          </ol>
        </nav>
      </div>
      <div class="p-3 mb-3 bg-light rounded">
    ...
    <div class="col-sm-9 blog-main">
      <div class="blog-post text-center">
        <h2 class="my-3">Votação para Senador</h2>

        <div class="alert alert-success">
          <?php echo "$textoInformativo"; ?>
        </div>

        <form action="votacaoSenador.php" method="post" enctype="multipart/form-data" class="border border-dark rounded-lg p-3">
          <div class="row mb-4">
            <?php
            if (empty($candidatos)) {
